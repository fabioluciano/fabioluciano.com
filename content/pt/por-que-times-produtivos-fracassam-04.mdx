...
<Tooltip client:load term="DORA Metrics" definition="Conjunto de 4 métricas que avaliam a capacidade de entrega de software: frequência de deploy, tempo de entrega, tempo de recuperação e taxa de falhas em mudanças.">As quatro métricas DORA</Tooltip> funcionam como termômetros, não como tratamento.
...
<ProsCons
  ...
  cons={[
    { text: "Funcionalidades fragmentadas artificialmente", emphasis: true },
