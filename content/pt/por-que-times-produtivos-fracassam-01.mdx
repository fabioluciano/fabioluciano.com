...
O "bus factor"<FootnoteRef client:load id={2} /> em 1 significa que uma única saída leva metade do conhecimento embora — não porque falta documentação, mas porque o sistema nunca deu tempo para criá-la.
