...
É nesse ponto que o modelo <Tooltip client:load term="SPACE" definition="Framework que propõe cinco dimensões para medir produtividade: Satisfaction, Performance, Activity, Communication e Collaboration, e Efficiency and Flow.">SPACE</Tooltip> se torna relevante.
