...
<Tooltip client:load term="DORA" definition="DevOps Research and Assessment. Framework focado em medir a capacidade de entrega de software através de métricas como frequência de implantação, lead time, MTTR e taxa de falhas.">DORA</Tooltip><FootnoteRef client:load id={2} /> — resultado de anos de pesquisa sobre práticas de DevOps — olha para a capacidade de entrega do time como um sistema de fluxo. Seu foco está em entender com que frequência mudanças chegam à produção, quanto tempo levam para chegar lá e o quão estável esse processo é.
...
<DefinitionList
  ...
  items={[
    ...
    {
      term: "Tempo de Entrega para Mudanças (Lead Time for Changes)",
      definition: "Quanto tempo entre commit e implantação em produção. Mede a rapidez da pipeline.",
      icon: "code"
    },
    {
...
<DefinitionList
  ...
  items={[
    {
      term: "Ciclos de Feedback (Feedback loops)",
...
<DefinitionList
  ...
  items={[
    {
      term: "Ciclos de Feedback Rápidos (Fast feedback loops)",
  ...
  root((Frameworks de Produtividade & DevEx))
    ...
    DX Core 4
      ...
      Pergunta
        Onde agir primeiro?
`}
  caption="Cada framework responde a uma pergunta diferente. DORA mede fluxo de entrega, SPACE força reflexão multidimensional, DevEx captura vivência cotidiana e DX Core 4 identifica alavancas de ação. Não são alternativas — são lentes complementares."
/>
...
<Callout type="warning" title="Sinais de que você chegou na Fase 4">
