  ...
  commands={[
    {
      cmd: "kubectl config",
      args: "get-clusters",
      description: "Recupera a lista de clusters disponíveis",
      category: "Consulta"
    },
    {
      cmd: "kubectl config",
      args: "set-cluster kind-cluster-3 --server https://127.0.0.1:56815 --certificate-authority certificate.cer",
      description: "Salva um novo cluster (com caminho de CA)",
    ...
    },
    {
      ...
      description: "Salva um novo cluster (com CA embutida)",
      category: "Modificação"
    },
    {
      cmd: "kubectl config",
      args: "delete-cluster cluster-3",
      description: "Remove um cluster",
      category: "Modificação"
    }
  ]}
/>
...
<CommandReference
  ...
  commands={[
    ...
    },
    {
      ...
      description: "Cria credencial OIDC",
      category: "Modificação"
    }
  ]}
/>
  ...
  commands={[
    {
      cmd: "kubectl config",
      args: "get-contexts",
      description: "Recupera a lista de contexts disponíveis",
      category: "Consulta"
    },
    {
      cmd: "kubectl config",
      args: "set-context prod-admin --cluster kind-cluster-1 --user kind-cluster-1",
      description: "Cria um novo context",
      category: "Modificação"
    },
    {
      cmd: "kubectl config",
      args: "set-context dev-user --cluster kind-cluster-2 --user dev-user --namespace app-frontend",
      description: "Cria um novo context com namespace padrão",
      category: "Modificação"
    },
    {
      cmd: "kubectl config",
      args: "use-context prod-admin",
      description: "Altera o context atual",
      category: "Gerenciamento de Contexto"
    },
    {
      cmd: "kubectl config",
      args: "delete-context dev-user",
      description: "Remove um context",
      category: "Modificação"
    }
  ]}
/>
