...
<Mermaid
  ...
  chart={`flowchart LR
    M((Mental<br/>Effort))
    E((Emotional<br/>Effort))
    S((Social<br/>Effort))

    M -->|Cognitive load<br/>creates insecurity| E
    E -->|Insecurity increases<br/>dependence| S
    S -->|Social friction<br/>consumes energy| M
  ...
  caption="The three types of effort are not independent — they form a self-reinforcing cycle. Bad DevEx amplifies this cycle; good DevEx interrupts it."
/>
...
<Callout type="tip" title="DevEx as an analytical tool">
  DevEx enters this conversation not as a magic solution, but as an **analytical lens**. A way to see where the system is wasting human energy to maintain the appearance of efficiency.
</Callout>
...
This transforms DevEx from a **systemic approach** into **individual responsibility**. The system remains dysfunctional, but now the narrative is: "It's not the system, it's you not knowing how to use the right tools."
...
Throughout this series, we'll examine models that promise to measure and improve productivity: DORA, SPACE, DevEx Framework, DX Core 4. All have value. **All can be used as theater.**

In [Article 4](/en/why-productive-teams-fail-04), we'll see how even well-intentioned approaches can **hide more than they reveal** — especially when legitimized by consultancies that sell consensus, not truth.

For now, it's enough to understand: **DevEx is a perspective for seeing systems, not a checklist of tools.** If someone is selling DevEx as a product, be suspicious. If someone is using DevEx to blame individuals, resist.
