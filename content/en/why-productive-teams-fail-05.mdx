...
This is where the <Tooltip client:load term="SPACE" definition="Framework proposing five dimensions to measure productivity: Satisfaction, Performance, Activity, Communication & Collaboration, and Efficiency & Flow.">SPACE</Tooltip><FootnoteRef client:load id={2} /> model becomes relevant.

<Callout type="info" title="An expansion, not correction">
...
<Callout type="warning" title="The radical premise">
...
<Callout type="info" title="The capacity argument">
...
<Callout type="warning" title="The survey paradox">
...
<ProsCons
  ...
  context="Satisfaction as an indicator of systemic health"
  variant="balanced"
  pros={[
    "Sustainable system",
...
<Callout type="tip" title="Speed vs quality">
...
<Callout type="warning" title="Hidden debt">
...
<Callout type="info" title="The performance lens">
...
<Callout type="warning" title="The invisible work">
...
<ProsCons
  ...
  context="How to interpret activity indicators"
  variant="balanced"
  pros={[
...
<Callout type="warning" title="The social overhead">
...
<Callout type="info" title="Time fragmentation">
...
<Callout type="danger" title="Collaboration overload">
...
<Callout type="tip" title="Structural constraints">
...
<Callout type="info" title="Contextualizing flow">
...
<Callout type="warning" title="Flow's vulnerability">
...
<Callout type="tip" title="System dynamics">
...
<Callout type="danger" title="Long-term thinking">
...
<Callout type="tip" title="Reframing the question">
...
<Mermaid
  client:load
  chart={`graph TB
    S["<b>S</b> - Satisfaction<br/><small>Well-being</small>"]
    P["<b>P</b> - Performance<br/><small>Quality</small>"]
    A["<b>A</b> - Activity<br/><small>Output</small>"]
    C["<b>C</b> - Communication<br/><small>Collaboration</small>"]
    E["<b>E</b> - Efficiency<br/><small>Flow</small>"]
...
`}
  caption="The 5 SPACE dimensions. Solid arrows = Tension (optimizing one may harm another). Dashed arrows = Synergy (dimensions reinforce each other)."
/>
...
<Callout type="danger" title="Who benefits?">
...
<ProsCons
  ...
  context="How the model can be used or abused"
  variant="warning"
  pros={[
...
<Callout type="warning" title="Misuse detection">
...
<Callout type="danger" title="The inherent risk">
...
<Callout type="danger" title="Uncomfortable truths">
...
<ProsCons
  ...
  context="The fundamental difference between the approaches"
  variant="balanced"
  pros={[
...
<Callout type="tip" title="Dual reality">
