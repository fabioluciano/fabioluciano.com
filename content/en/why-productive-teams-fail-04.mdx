...
<Callout type="info" title="The diagnostic value">
...
<Callout type="danger" title="Surface-level implementation">
...
<Callout type="warning" title="The cultural foundation">
...
<ProsCons
  ...
  context="Impact of culture on DORA indicators"
  variant="balanced"
  pros={[
...
<Callout type="danger" title="The 3 AM test">
...
<Callout type="warning" title="The scope limitation">
...
<Callout type="danger" title="The blind spot">
...
When measurements become targets, systems start gaming against them. Not out of malice, but through organizational dynamics<FootnoteRef client:load id={2} />.
...
<Callout type="danger" title="The false positive">
...
<Callout type="danger" title="The ideological shift">
...
<Callout type="info" title="What Gartner actually is">
...
<Callout type="danger" title="Lost in translation">
...
<Callout type="danger" title="The market dynamics">
...
<ProsCons
  ...
  context="Structural limits of the approach"
  variant="balanced"
  pros={[
    "Pipeline speed",
    "Deploy stability",
...
<Callout type="warning" title="The consequence of ignoring limits">
...
<Callout type="tip" title="The complementary approach">
...
<Callout type="info" title="The sequence">
...
<Callout type="danger" title="The fundamental decision">
  Before choosing DORA (or any approach), choose the problem you want to solve. If this choice isn't conscious, the system will make it for you. And systems don't care about burnout, context, or people — they optimize for what's measured.
</Callout>
