...
<Mermaid
  ...
  chart={`flowchart TB
    subgraph sources[Data Sources]
        common[common.yaml<br/>shared data]
        en[resume.en.yaml<br/>translations]
        ptbr[resume.ptbr.yaml<br/>translations]
    end

    schema[JSON Resume Schema<br/>validation]
